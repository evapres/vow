...
const outlineSecondaryClass =
  "flex h-full w-full cursor-pointer items-center justify-center border-0 bg-transparent p-0 font-sans text-[14px] font-bold uppercase tracking-[0.09em] transition-colors disabled:pointer-events-none disabled:opacity-60";
